...
function applyTheme(theme) {
  ...
  const allThemes = ['minimal', 'warm', 'blue', 'mint', 'navy', 'rose', 'sand', 'ocean', 'forest', 'lavender', 'sunset', 'graphite', 'coral', 'olive', 'midnight'];
  container.classList.remove(...allThemes.map(t => `theme-${t}`));
...
/* Theme color schemes (editor-grade, low saturation) */
:host(.theme-minimal) {
  --bg: #fafafa;
  --fg: #1a1a1a;
  --fg-secondary: #8c8c8c;
...
:host(.theme-warm) {
  ...
  --divider: #ddd2bf;
  --danger: #a05a4f;
  --shadow: 0 16px 44px rgba(92, 80, 68, .12);
}
...
:host(.theme-blue) {
  ...
  --divider: #e1dcc8;
  --danger: #cb4b16;
  --shadow: 0 16px 44px rgba(38, 139, 210, .10);
}
...
:host(.theme-mint) {
  ...
  --divider: #d8dee4;
  --danger: #cf222e;
  --shadow: 0 16px 44px rgba(36, 41, 47, .10);
}
...
:host(.theme-navy) {
  ...
  --divider: #d1d8e0;
  --danger: #b54a4a;
  --shadow: 0 16px 44px rgba(46, 52, 64, .10);
}
...
:host(.theme-rose) {
  ...
  --divider: #e8e0d7;
  --danger: #b4637a;
  --shadow: 0 16px 44px rgba(87, 82, 121, .10);
}
...
:host(.theme-sand) {
  ...
  --divider: #ebd9b0;
  --danger: #cc241d;
  --shadow: 0 16px 44px rgba(60, 56, 54, .10);
}
...
:host(.theme-ocean) {
  ...
  --divider: #d7dde0;
  --danger: #a8514a;
  --shadow: 0 16px 44px rgba(55, 71, 79, .10);
}
...
:host(.theme-forest) {
  ...
  --divider: #d4dcd0;
  --danger: #a05a4f;
  --shadow: 0 16px 44px rgba(47, 59, 44, .10);
}
...
:host(.theme-lavender) {
  ...
  --divider: #ddd9eb;
  --danger: #a8514a;
  --shadow: 0 16px 44px rgba(59, 56, 79, .10);
}
...
:host(.theme-sunset) {
  ...
  --divider: #e0dbd3;
  --danger: #b3553e;
  --shadow: 0 16px 44px rgba(92, 103, 115, .10);
}
...
:host(.theme-graphite) {
  ...
  --divider: #d6d6d6;
  --danger: #a8514a;
  --shadow: 0 16px 44px rgba(45, 45, 45, .10);
}
...
:host(.theme-coral) {
  ...
  --divider: #e0d8d2;
  --danger: #a8514a;
  --shadow: 0 16px 44px rgba(66, 58, 54, .10);
}
...
:host(.theme-olive) {
  ...
  --divider: #dadaCC;
  --danger: #a8514a;
  --shadow: 0 16px 44px rgba(56, 56, 46, .10);
}
